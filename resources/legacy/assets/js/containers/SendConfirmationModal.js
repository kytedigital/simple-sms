                    ...
                    <Modal.Section>
                        <TextContainer spacing="loose">
                            ...
                            <TextStyle variation="subdued">
                                ...
                                have relevant authorisation to contact the recipient(s) and have
                                included the following in your message body, and covered any additional
                                requirements pursuant to applicable SPAM laws in your region, and
                                the region of the recipients.
                                <ul>
                                    <li>Identification of your business (shop name / brand)</li>
                                    <li>Valid contact information</li>
                                    <li>Clear Opt-Out Instructions (E.g.
